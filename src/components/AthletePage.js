...
const AthletePage = (props) => {
  ...
  const athlete = athletes.filter(oneAthlete => oneAthlete.id === id)[0];
    ...
    <div className="athlete-full">
      ...
      <div className="athlete">
        ...
        <div className="picture-container">
          <img alt="athlete" src={`/img/${athlete.image}`} />
        ...
        <section className="description">
          ...
          <a href={athlete.link} target="_blank" rel="noopener noreferrer">Wikipedia</a>
        </section>
...
AthletePage.propTypes = {
  params: React.PropTypes.element,
};
